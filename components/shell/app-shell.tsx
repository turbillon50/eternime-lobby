...
export const APP_NAV: NavItem[] = [
  ...
  { href: "/app/integraciones", label: "Conexiones", icon: <Icon d="M8 12h8M7 8H5a4 4 0 0 0 0 8h2M17 8h2a4 4 0 0 1 0 8h-2" /> },
  { href: "/app/videos", label: "Videos y redes", icon: <Icon d="M4 6h16v12H4zM10 9l5 3-5 3V9Z" /> },
