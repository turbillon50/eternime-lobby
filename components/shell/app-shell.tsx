...
const FUTURE = ["Mi Red", "Proyectos", "Calendario", "Pendientes", "Documentos", "Bóveda"];
...
export function AppShell({ children, nav: _nav, brand: _brand }: PropsWithChildren<{ nav?: NavItem[]; brand?: string }>) {
  ...
  return <div className="eon-app min-h-svh">
    ...
    <nav className="eon-tabbar" aria-label="Navegación principal">
      ...
      <Link href="/app/beneficiarios" className={pathname.startsWith("/app/beneficiarios") ? "active" : ""}><Icon d="M5 18c2-3 4-4 7-4s5 1 7 4M8 9a4 4 0 1 0 8 0"/><span>Personas</span></Link>
