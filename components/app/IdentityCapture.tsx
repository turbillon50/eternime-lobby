...
export function IdentityCapture(){
 const input=useRef<HTMLInputElement>(null);const [assets,setAssets]=useState<Asset[]>([]),[working,setWorking]=useState(false),[err,setErr]=useState("");
