...
export function GlobalControls() {
  ...
  return (
    <div className="et-fab" role="group" aria-label="Ajustes de tema e idioma">
      ...
      <button type="button" data-active={lang === "es"} onClick={() => applyLang("es")} aria-label="Cambiar idioma a Español">ES</button>
      <button type="button" data-active={lang === "en"} onClick={() => applyLang("en")} aria-label="Switch language to English">EN</button>
    </div>
  );
}
