...
export default async function HomePage() {
  ...
  return <div className="eon-public-home">
    <section className="eon-public-hero va-crystal va-spatial">
      ...
      <EonSignal className="eon-public-signal" label="EON, inteligencia de memoria activa" />
      ...
      <div className="actions"><Link href="/sign-up" className="primary">Empezar</Link><Link href="/sign-in" className="secondary">Ya tengo cuenta</Link></div>
    ...
    <section className="eon-mcp-public va-crystal">
      ...
      <Link href="/sign-up">Crear mi memoria portátil →</Link>
    </section>

    <section className="eon-public-statement va-spatial"><p>Un asistente que no sólo responde.</p><h2>Te conoce porque recuerda contigo.</h2><Link href="/sign-up">Crear mi memoria →</Link></section>
  </div>;
}
